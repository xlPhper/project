 ...
 * Generated for Laravel 5.2.10 on 2016-01-15.
 *
...
namespace {
    ...
    class Wechat extends \Overtrue\LaravelWechat\Facade{
         ...
         * @static 
         */
        public static function on($target, $type, $callback = null){
            return \Overtrue\Wechat\Server::on($target, $type, $callback);
        }
         ...
         * @static 
         */
        public static function event($type, $callback = null){
            return \Overtrue\Wechat\Server::event($type, $callback);
        }
         ...
         * @static 
         */
        public static function message($type, $callback = null){
            return \Overtrue\Wechat\Server::message($type, $callback);
        }
        ...
        public static function serve(){
            return \Overtrue\Wechat\Server::serve();
        }
